...
def ensure_model_exists():
    ...
    if os.path.exists(model_path):
        log.info(f"✅ Modelo existe: {model_path}")
        return True
    
    try:
        log.info("📥 Descargando modelo YOLOv8...")
        import urllib.request
        url = "https://github.com/ultralytics/assets/releases/download/v8.2.0/yolov8n.pt"
        urllib.request.urlretrieve(url, model_path)
        log.info(f"✅ Modelo descargado: {model_path}")
        return True
...
# Ejecutar al iniciar
log.info("🚀 Inicializando Handball Goal Counter...")
ensure_model_exists()
